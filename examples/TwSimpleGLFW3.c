...
{  
  ...
  // TwWindowSize(100, 300);
  // Create a tweak bar
  char *myString = (char *)malloc(1024);
  strcpy(myString, "Initial text");
  ...
  // TwAddVarRW(bar, "Text", TW_TYPE_CDSTRING, myString,
  //             " label='Text to change' maxlen=1024 ");
/*
